  ...
  parts: [
    {
      ...
      sections: [
        { title: "Définition", content: "Une rotation dans le plan est une transformation géométrique qui fait tourner tous les points autour d'un point fixe appelé centre de rotation, selon un angle donné. Une rotation de centre O et d'angle θ transforme un point M en un point M' tel que: OM' = OM et (OM', OM) = θ." },
        { title: "Exemple", content: "La rotation de centre O(0,0) et d'angle π/2 (90°) transforme le point M(1,0) en M'(0,1)." },
        { title: "Remarque", content: "La rotation conserve les distances, les angles et les aires. Elle est utilisée pour étudier les symétries et les propriétés des figures géométriques." }
      ],
      gameQuestions: [
    ...
    },
    {
      ...
      sections: [
        { title: "Définition", content: "Dans le plan complexe, une rotation de centre O et d'angle θ s'exprime simplement: si z est l'affixe d'un point M et z₀ l'affixe du centre de rotation, alors l'affixe z' du point M' image de M est donnée par: z' - z₀ = e^(iθ)(z - z₀)." },
        { title: "Exemple", content: "Pour une rotation de centre O(0,0) et d'angle π/2, on a z' = e^(iπ/2) × z = i × z. Si z = 2 + 3i, alors z' = i × (2 + 3i) = i × 2 + i × 3i = 2i - 3 = -3 + 2i." },
        { title: "Remarque", content: "La représentation complexe des rotations simplifie les calculs et permet d'étudier les transformations du plan de façon élégante et efficace." }
      ],
      gameQuestions: [
    ...
    },
    {
      ...
      sections: [
        { title: "Définition", content: "Les rotations jouent un rôle important en géométrie: construction de polygones réguliers, étude des symétries, des transformations du plan. Une rotation d'angle 2π/n permet de construire un polygone régulier à n côtés. La composition de deux rotations de même centre est une rotation de même centre, d'angle égal à la somme des angles." },
        { title: "Exemple", content: "Un hexagone régulier peut être construit en appliquant successivement une rotation d'angle 2π/6 = π/3 à partir d'un point quelconque. Les sommets sont tous situés sur un cercle centré au centre de rotation." },
        { title: "Remarque", content: "Les applications géométriques des rotations sont nombreuses, notamment dans la construction de figures régulières et l'étude des symétries du plan." }
      ],
      gameQuestions: [
