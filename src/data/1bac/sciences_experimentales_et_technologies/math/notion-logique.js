  ...
  parts: [
    {
      ...
      definition: "Une proposition est une assertion qui est soit vraie, soit fausse. Les opérations logiques de base sont la négation (¬), la conjonction (∧), la disjonction (∨) et l'implication (⇒).",
      example: "Si p: 'Il pleut' et q: 'La route est mouillée', alors p⇒q signifie 'S'il pleut, alors la route est mouillée'.",
      gameQuestions: [
    ...
    },
    {
      ...
      definition: "Les quantificateurs universel (∀) et existentiel (∃) permettent d'exprimer des propositions sur des ensembles. Un raisonnement valide respecte les règles de la logique formelle.",
      example: "La proposition '∀x∈ℝ, x²≥0' signifie 'Pour tout nombre réel x, le carré de x est positif ou nul'.",
      gameQuestions: [
    ...
    },
    {
      ...
      definition: "Les principales méthodes de démonstration sont la preuve directe, la preuve par contraposition, la preuve par l'absurde et la preuve par récurrence.",
      example: "Pour démontrer que 'si n² est pair, alors n est pair', on peut utiliser la contraposition: 'si n est impair, alors n² est impair'.",
      gameQuestions: [
