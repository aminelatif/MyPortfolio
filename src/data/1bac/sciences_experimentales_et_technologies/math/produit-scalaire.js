  ...
  parts: [
    {
      ...
      definition: "Le produit scalaire de deux vecteurs ⃗u et ⃗v du plan est défini par ⃗u·⃗v = ||⃗u||·||⃗v||·cos(θ) où θ est l'angle entre les deux vecteurs. Dans un repère orthonormé, si ⃗u(x₁, y₁) et ⃗v(x₂, y₂), alors ⃗u·⃗v = x₁x₂ + y₁y₂.",
      example: "Pour ⃗u(3, 4) et ⃗v(1, 2), le produit scalaire est ⃗u·⃗v = 3×1 + 4×2 = 3 + 8 = 11.",
      gameQuestions: [
    ...
    },
    {
      ...
      definition: "Le produit scalaire permet de caractériser l'orthogonalité (⃗u·⃗v = 0), de calculer des angles (cos(θ) = ⃗u·⃗v/(||⃗u||·||⃗v||)), des distances et des projections orthogonales.",
      example: "Pour déterminer l'angle entre ⃗u(1, 1) et ⃗v(0, 1), on calcule cos(θ) = ⃗u·⃗v/(||⃗u||·||⃗v||) = 1/(√2×1) = 1/√2 = √2/2, donc θ = π/4 = 45°.",
      gameQuestions: [
    ...
    },
    {
      ...
      definition: "Dans un repère orthonormé, plusieurs formules font intervenir le produit scalaire: la distance entre deux points A(x₁, y₁) et B(x₂, y₂) est d(A,B) = ||⃗AB|| = √[(x₂-x₁)² + (y₂-y₁)²]. L'équation d'un cercle de centre Ω(a, b) et de rayon R est (x-a)² + (y-b)² = R².",
      example: "L'équation d'une droite perpendiculaire à un vecteur ⃗n(a, b) passant par un point P(x₀, y₀) est a(x-x₀) + b(y-y₀) = 0, ce qui se réécrit ax + by + c = 0 avec c = -(ax₀ + by₀).",
      gameQuestions: [
