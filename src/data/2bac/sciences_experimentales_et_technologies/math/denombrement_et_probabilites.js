  ...
  parts: [
    {
      ...
      sections: [
        ...
        { title: "Remarque", content: "Le dénombrement est essentiel pour l'analyse des expériences aléatoires en sciences expérimentales." }
      ],
      gameQuestions: [
    ...
    },
    {
      ...
      sections: [
        ...
        { title: "Remarque", content: "Les probabilités sont fondamentales pour l'analyse des phénomènes aléatoires en sciences expérimentales." }
      ],
      gameQuestions: [
